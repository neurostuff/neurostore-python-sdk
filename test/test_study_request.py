...
from neurostore_sdk.models.study_request import StudyRequest  # noqa: E501
...
class TestStudyRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `StudyRequest`
        """
        model = neurostore_sdk.models.study_request.StudyRequest()  # noqa: E501
        if include_optional :
            return StudyRequest(
