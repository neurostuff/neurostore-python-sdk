...
class DefaultApi(object):
    ...
    @validate_arguments
    def annotations_options(self, **kwargs) -> None:  # noqa: E501
        """  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.annotations_options(async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the annotations_options_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.annotations_options_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    def annotations_options_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.annotations_options_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method annotations_options" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
