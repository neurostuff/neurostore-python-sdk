...
class PageSizeSchema(
    ...
    class MetaOapg:
        format = 'int32'
        exclusive_maximuminclusive_maximum = 30000
        inclusive_minimum = 1
FilenameSchema = schemas.StrSchema
AnalysisNameSchema = schemas.StrSchema
ValueTypeSchema = schemas.StrSchema
SpaceSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'analysis_name': typing.Union[AnalysisNameSchema, str, ],
        'value_type': typing.Union[ValueTypeSchema, str, ],
...
request_query_analysis_name = api_client.QueryParameter(
    name="analysis_name",
    style=api_client.ParameterStyle.FORM,
    schema=AnalysisNameSchema,
    explode=True,
)
request_query_value_type = api_client.QueryParameter(
    name="value_type",
    style=api_client.ParameterStyle.FORM,
...
SchemaFor200ResponseBodyApplicationJson = ImageList
...
class BaseApi(api_client.Api):
    ...
    def _images_get_oapg(
        ...
        for parameter in (
            ...
            request_query_analysis_name,
            request_query_value_type,
            request_query_space,
        ):
