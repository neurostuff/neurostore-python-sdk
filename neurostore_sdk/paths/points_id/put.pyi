...
# body param
SchemaForRequestBodyApplicationJson = PointRequest


request_body_point_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor200ResponseBodyApplicationJson = PointReturn
...
class BaseApi(api_client.Api):
    ...
    def _points_id_put_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_point_request.serialize(body, content_type)
...
class PointsIdPut(BaseApi):
    ...
    def points_id_put(
        ...
        return self._points_id_put_oapg(
            body=body,
