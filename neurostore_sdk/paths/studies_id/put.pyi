...
# body param
SchemaForRequestBodyApplicationJson = StudyRequest


request_body_study_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor200ResponseBodyApplicationJson = StudyReturn
...
class BaseApi(api_client.Api):
    ...
    def _studies_id_put_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_study_request.serialize(body, content_type)
...
class StudiesIdPut(BaseApi):
    ...
    def studies_id_put(
        ...
        return self._studies_id_put_oapg(
            body=body,
