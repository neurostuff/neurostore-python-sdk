...
# body param
SchemaForRequestBodyApplicationJson = ImageRequest


request_body_image_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ImageReturn
...
class BaseApi(api_client.Api):
    ...
    def _images_id_put_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_image_request.serialize(body, content_type)
...
class ImagesIdPut(BaseApi):
    ...
    def images_id_put(
        ...
        return self._images_id_put_oapg(
            body=body,
