...
# body param
SchemaForRequestBodyApplicationJson = AnalysisRequest


request_body_analysis_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = AnalysisReturn
...
class BaseApi(api_client.Api):
    ...
    def _analyses_id_put_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_analysis_request.serialize(body, content_type)
...
class AnalysesIdPut(BaseApi):
    ...
    def analyses_id_put(
        ...
        return self._analyses_id_put_oapg(
            body=body,
