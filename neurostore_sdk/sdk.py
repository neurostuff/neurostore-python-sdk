"""Ergonomic SDK facade for neurostore_sdk."""
...
from neurostore_sdk.auth import Auth0RefreshTokenAuth
...
def _discover_api_classes() -> Tuple[Dict[str, ApiClass], List[str]]:
    ...
    api_package = importlib.import_module("neurostore_sdk.api")
    ...
    for module_info in pkgutil.iter_modules(api_package.__path__):
        ...
        module = importlib.import_module(f"neurostore_sdk.api.{module_name}")
