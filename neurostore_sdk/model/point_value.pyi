...
class PointValue(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["kind", "value", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["kind", "value", ], str]):
