...
class NoteCollectionReturn(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NoteCollectionReturn:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NoteCollectionReturn:
        """Create an instance of NoteCollectionReturn from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NoteCollectionReturn.parse_obj(obj)

        _obj = NoteCollectionReturn.parse_obj({
            "note": obj.get("note"),
