...
class PipelineEmbeddingList(BaseModel):
    """
    PipelineEmbeddingList
    """ # noqa: E501
    results: Optional[List[PipelineEmbedding]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [PipelineEmbedding.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
