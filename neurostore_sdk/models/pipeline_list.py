...
class PipelineList(BaseModel):
    ...
    PipelineList
    """
    results: Optional[conlist(Pipeline)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PipelineList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PipelineList:
        """Create an instance of PipelineList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PipelineList.parse_obj(obj)

        _obj = PipelineList.parse_obj({
            "results": [Pipeline.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None,
