...
class PipelineRunList(BaseModel):
    ...
    PipelineRunList
    """
    results: Optional[conlist(PipelineRun)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PipelineRunList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PipelineRunList:
        """Create an instance of PipelineRunList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PipelineRunList.parse_obj(obj)

        _obj = PipelineRunList.parse_obj({
            "results": [PipelineRun.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None,
