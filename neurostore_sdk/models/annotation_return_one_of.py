...
class AnnotationReturnOneOf(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AnnotationReturnOneOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AnnotationReturnOneOf:
        """Create an instance of AnnotationReturnOneOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AnnotationReturnOneOf.parse_obj(obj)

        _obj = AnnotationReturnOneOf.parse_obj({
