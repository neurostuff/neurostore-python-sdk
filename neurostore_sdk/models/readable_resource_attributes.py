...
T = TypeVar("T", bound="ReadableResourceAttributes")


@attr.s(auto_attribs=True)
class ReadableResourceAttributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        readable_resource_attributes = cls(
            created_at=created_at,
            updated_at=updated_at,
        )

        readable_resource_attributes.additional_properties = d
        return readable_resource_attributes
