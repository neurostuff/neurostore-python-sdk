...
class ConditionList(BaseModel):
    ...
    ConditionList
    """
    results: Optional[conlist(ConditionReturn)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConditionList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConditionList:
        """Create an instance of ConditionList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConditionList.parse_obj(obj)

        _obj = ConditionList.parse_obj({
            "results": [ConditionReturn.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None,
