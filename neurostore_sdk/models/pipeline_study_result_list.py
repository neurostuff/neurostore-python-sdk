...
class PipelineStudyResultList(BaseModel):
    ...
    """ # noqa: E501
    results: Optional[List[PipelineStudyResult]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [PipelineStudyResult.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
