...
class PointReturn(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["coordinates", "space", "kind", "label_id", "created_at", "updated_at", "id", "public", "user", "username", "image", "values", "x", "y", "z", "entities", "analysis", "cluster_size", "subpeak", "deactivation", "order"]
