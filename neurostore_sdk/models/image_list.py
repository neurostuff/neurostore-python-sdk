...
class ImageList(BaseModel):
    ...
    ImageList
    """
    results: Optional[conlist(ImageReturn)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ImageList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ImageList:
        """Create an instance of ImageList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ImageList.parse_obj(obj)

        _obj = ImageList.parse_obj({
            "results": [ImageReturn.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None,
