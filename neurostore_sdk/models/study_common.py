...
class StudyCommon(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StudyCommon:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StudyCommon:
        """Create an instance of StudyCommon from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StudyCommon.parse_obj(obj)

        _obj = StudyCommon.parse_obj({
            "level": obj.get("level")
        })
        return _obj
