...
class StudyRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["doi", "name", "metadata", "description", "publication", "pmid", "authors", "year", "analyses", "id", "public", "pmcid"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "year": obj.get("year"),
            "analyses": StudyRequestRelationshipsAnalyses.from_dict(obj["analyses"]) if obj.get("analyses") is not None else None,
            "id": obj.get("id"),
