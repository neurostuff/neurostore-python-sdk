...
class AnnotationList(BaseModel):
    ...
    AnnotationList
    """
    results: Optional[conlist(AnnotationReturn)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AnnotationList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AnnotationList:
        """Create an instance of AnnotationList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AnnotationList.parse_obj(obj)

        _obj = AnnotationList.parse_obj({
            "results": [AnnotationReturn.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None,
