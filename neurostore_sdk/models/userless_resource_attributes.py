...
T = TypeVar("T", bound="UserlessResourceAttributes")


@attr.s(auto_attribs=True)
class UserlessResourceAttributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        userless_resource_attributes = cls(
        ...
        userless_resource_attributes.additional_properties = d
        return userless_resource_attributes
