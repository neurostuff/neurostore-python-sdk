...
class AbstractStudyReturn(BaseModel):
    """
    AbstractStudyReturn
    """
    metadata: Optional[Dict[str, Any]] = None
    versions: Optional[AbstractStudyVersions] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AbstractStudyReturn:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AbstractStudyReturn:
        """Create an instance of AbstractStudyReturn from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AbstractStudyReturn.parse_obj(obj)

        _obj = AbstractStudyReturn.parse_obj({
            "metadata": obj.get("metadata"),
            "versions": AbstractStudyVersions.from_dict(obj.get("versions")) if obj.get("versions") is not None else None,
            "name": obj.get("name"),
