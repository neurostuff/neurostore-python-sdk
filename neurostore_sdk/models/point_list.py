...
class PointList(BaseModel):
    ...
    PointList
    """
    results: Optional[conlist(PointReturn)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PointList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PointList:
        """Create an instance of PointList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PointList.parse_obj(obj)

        _obj = PointList.parse_obj({
            "results": [PointReturn.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None,
