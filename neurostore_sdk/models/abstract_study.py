...
class AbstractStudy(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AbstractStudy:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AbstractStudy:
        """Create an instance of AbstractStudy from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AbstractStudy.parse_obj(obj)

        _obj = AbstractStudy.parse_obj({
